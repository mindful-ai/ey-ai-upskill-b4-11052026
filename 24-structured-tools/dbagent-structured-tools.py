...
path = r"E:\Lenovo Ideapad 330\company-material\digital-workforce-transformation\ai-upskill-4\key-vault\huggingface\hg-api-key.txt"
f = open(path)
api_key = f.read()
f.close()
...
"""
    ...
    response = agent.invoke({
        "messages": [
            {"role": "user", "content": "Add a user named Smitha with id ML810"}
        ]
    })
